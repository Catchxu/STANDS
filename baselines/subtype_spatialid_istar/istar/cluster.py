...
def main_my(d, n_clusters=10, filter_size=8, min_cluster_size=20):

    embs = load_pickle(d+'embeddings-gene.pickle')
    ...
    mask = load_mask(d+'mask-small.png')
    x[:, ~mask] = np.nan
